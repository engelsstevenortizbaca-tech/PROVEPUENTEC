...
// El logo se guarda como URL absoluta (columna VARCHAR(500)).
const logoUrlRule = (chain) =>
  chain
    .isString()
    .trim()
    .isLength({ max: 500 })
    .withMessage('logoUrl no puede superar 500 caracteres')
    .isURL({ protocols: ['http', 'https'], require_protocol: true })
    .withMessage('logoUrl debe ser una URL http(s) válida');
